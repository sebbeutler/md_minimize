...
# Water molecule 2
O2 = system.add_atom('O2', 'H20', '2', -0.834, np.array([3.0, 5.0]))
H3 = system.add_atom('H3', 'H20', '2', 0.417, np.array([2.0, 6.0]))
H4 = system.add_atom('H4', 'H20', '2', 0.417, np.array([4.0, 6.0]))
